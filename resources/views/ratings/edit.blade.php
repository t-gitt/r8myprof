<title>{{ config('app.name', 'Laravel') . ' | ' . 'Edit a rating' }}</title>
@extends('layouts.app')
...
{!! Form::open(['action' => ['RatingsController@update', $rating->id], 'method' => 'POST']) !!}
...
<hr>
	...
	<br>
		...
		{{Form::textarea('comment', $rating->comment, ['class' => 'form-control', 'placeholder' => 'Comment'])}}
